...
public class Main extends ApplicationAdapter {
	...
	public void create () {
		...
		TiledMap map = new TmxMapLoader().load("maps/rooms/room_jungle/prueba.tmx"); //Cargamos el tilemap desde assets
		...
		camera.position.y = Math.max(camera.position.y -10,0);
