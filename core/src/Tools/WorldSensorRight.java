 ...
 *
 *  WorldSensorRight make a sensor collision to the Right wall
 *  thats make the enemy check the colission in WorldContact and change direction.
 *
 */
public class WorldSensorRight {
    ...
    //Constructor of WorldSensorRight
    public WorldSensorRight(World world, PlayScreen screen) {
        this.world = world;
        defineSensor();
    ...
    public void defineSensor(){
        ...
        b2body.setTransform(510/Main.ppm, 100/Main.ppm , 0);
